...
以下内容按 GitHub Release 的实际发布时间窗口整理；“未发布”包含 v1.9.2 发布之后已进入主分支、但尚未打包发布的改动。

### 🚧 未发布 — macOS 窗口修复与 UA 对齐

> 本阶段重点修复 v1.9.2 发布后用户反馈的 macOS 启动问题，并将 API 请求的 User-Agent 与真实 Kiro IDE 完全对齐。
