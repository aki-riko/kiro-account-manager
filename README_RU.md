...
**Последняя версия v1.8.6** (выпущена 2026-05-10): пожалуйста, посетите [Releases](https://github.com/hj01857655/kiro-account-manager/releases/latest) (автоматически поддерживается актуальной)
...
|----------|-------------|-------------|---------------|
| 🪟 **Windows** | x64 | MSI установщик | [KiroAccountManager_1.8.6_x64_zh-CN.msi](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_x64_zh-CN.msi) |
| 🍎 **macOS** | Intel (x64) | DMG образ | [KiroAccountManager_1.8.6_x64.dmg](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_x64.dmg) |
| 🍎 **macOS** | Apple Silicon (M1/M2/M3) | DMG образ | [KiroAccountManager_1.8.6_aarch64.dmg](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_aarch64.dmg) |
...
| 🐧 **Linux** | x86_64 | DEB пакет | [KiroAccountManager_1.8.6_amd64.deb](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_amd64.deb) |
...
<p align="center"><sub>Последнее обновление: 2026-05-10 | Версия: v1.8.6</sub></p>