...
### 🏗️ v1.9.2 - 2026-06-17 — поддержка архитектуры Linux ARM64

> Этот релиз добавляет полную поддержку архитектуры **Linux ARM64**, позволяя запускать приложение на Raspberry Pi, ARM-серверах и других устройствах.
...
### 🚧 Не выпущено — исправление окна macOS и выравнивание UA

> Устраняет проблему запуска на macOS, о которой сообщили после v1.9.2, и приводит User-Agent API-запросов в полное соответствие с реальным Kiro IDE.
