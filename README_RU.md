...
| 🪟 **Windows** | ARM64 | MSI установщик | [KiroAccountManager_1.9.1_arm64_zh-CN.msi](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.9.1/KiroAccountManager_1.9.1_arm64_zh-CN.msi) |
| 🍎 **macOS** | x64 / Intel | DMG образ | [KiroAccountManager_1.9.1_x64.dmg](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.9.1/KiroAccountManager_1.9.1_x64.dmg) |
| 🍎 **macOS** | x64 / Intel | App архив | [KiroAccountManager_x64.app.tar.gz](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.9.1/KiroAccountManager_x64.app.tar.gz) |
| 🍎 **macOS** | ARM64 / Apple Silicon (M1/M2/M3/M4) | DMG образ | [KiroAccountManager_1.9.1_aarch64.dmg](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.9.1/KiroAccountManager_1.9.1_aarch64.dmg) |
| 🍎 **macOS** | ARM64 / Apple Silicon (M1/M2/M3/M4) | App архив | [KiroAccountManager_aarch64.app.tar.gz](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.9.1/KiroAccountManager_aarch64.app.tar.gz) |
...
| 🐧 **Linux** | x86_64 | RPM пакет | [KiroAccountManager-1.9.1-1.x86_64.rpm](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.9.1/KiroAccountManager-1.9.1-1.x86_64.rpm) |
